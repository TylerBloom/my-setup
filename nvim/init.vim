...
" Type ",/" in normal mode to ignore the current search
...
" text object based plugins
" allow commenting on text objects
Plug 'tpope/vim-commentary'
" define text objects for indented blocks
Plug 'michaeljsmith/vim-indent-object'
" allow arbitrary, user-defined text objects
" python text objects
...
" vim-grepper supports ag and ack
...
" This causes VERY strange highlighting and other issues when switching
" between py files with nerdtree when enabled... Something to look into
